...
public class Cl09LayoutAlignment extends DataChainLinkComputationAbstract {
	...
	public IvMObject<?>[] createInputObjects() {
		return new IvMObject<?>[] { IvMObject.model, IvMObject.aligned_log_info, IvMObject.selected_visualisation_mode,
				IvMObject.selected_graph_user_settings, IvMObject.attributes_info, IvMObject.imlog_info, IvMObject.imlog_activity_filtered, IvMObject.activity_attributes};
	}
	...
	public IvMObjectValues execute(InductiveVisualMinerConfiguration configuration, IvMObjectValues inputs,
		...
		HashMap <String, Object[][]> activity_attributes = inputs.get(IvMObject.activity_attributes);
		...
		if (model.isTree()) {
			...
			p = visualiser.fancy(model, data, visualisationParameters, attributesInfo, true, log, activity_attributes);
		} else {
